...
const testCases = [
  ...
  { id: 'Pos_Fun_0003', name: 'Convert complex conditional sentence', input: 'mama raenda unavothai mama TV balanavaa', expected: 'මම රෑඳ උනොත් මම TV බලනවා' },
  ...
  { id: 'Pos_Fun_0007', name: 'Convert present tense with mixed English term', input: 'mama dhaen vaeda karanava office eke', expected: 'මම දැන් වැඩ කරනව office එකේ' },
  ...
  { id: 'Pos_Fun_0016', name: 'Convert past tense with multiple tech terms', input: 'mama Google eken search kalaa information eka', expected: 'මම Google එකෙන් search කලා information ඒක' },
  { id: 'Pos_Fun_0017', name: 'Convert imperative with tech brand name', input: 'Facebook eke profile eka check karanna', expected: 'Facebook එකේ profile ඒක check කරන්න' },
  { id: 'Pos_Fun_0018', name: 'Convert sentence with place name and transport', input: 'api Kandy walata yanava bus eken heeta', expected: 'අපි Kandy වලට යනව bus එකෙන් හෙට' },
  { id: 'Pos_Fun_0019', name: 'Convert question with technical abbreviations', input: 'mata WiFi password eka kiyanna puLuvandha?', expected: 'මට WiFi password ඒක කියන්න පුළුවන්ද?' },
  { id: 'Pos_Fun_0020', name: 'Convert sentence with abbreviation NIC', input: 'mata NIC eka pennanna oonee adha', expected: 'මට NIC ඒක පෙන්නන්න ඕනේ අද' },
  { id: 'Pos_Fun_0021', name: 'Convert double question with punctuation', input: 'api yanavaadha? naththan innavaadha?', expected: 'අපි යනවාද? නත්තන් ඉන්නවාද?' },
  ...
  { id: 'Pos_Fun_0023', name: 'Convert medium length workplace communication', input: 'meeting eka 10.00 AM schedule kalaa. api hama dhenaama meeting ekata join venna oonee. Zoom link eka email eken evanna. mata adha raathriye details tika pennanna.', expected: 'meeting ඒක 10.00 AM schedule කලා. අපි හම දෙනාම meeting එකට join වෙන්න ඕනේ. Zoom link ඒක email එකෙන් එවන්න. මට අද රාත්\u200dරියේ details ටික පෙන්නන්න.' },
  { id: 'Pos_Fun_0024', name: 'Convert long narrative paragraph with multiple tenses', input: 'mama adha paasal giyaa. paasal eke friends la ekkaa raenaila hitiyaa. api lunch break eke kantiin eke bath kaalaa. passe library eke gihin pusthakalayakin books kihipayak gaththa. eevee thibapaththakin mama gedhara aavaa. gedhara aavama kaeema kaalaa. raeyin TV balanna hitiya evita nidhaganna giyaa. mama aadharei adha davasa gana.', expected: 'මම අද පාසල් ගියා. පාසල් එකේ friends ල එක්ක රෑනෑල හිටියා. අපි lunch break එකේ කැන්ටීන් එකේ බත් කාලා. පස්සේ library එකේ ගිහින් පුස්තකාලයකින් books කීපයක් ගත්ත. ඒවේ තිබපත්තකින් මම ගෙදර ආවා. ගෙදර ආවම කෑම කාලා. රෑයින් TV බලන්න හිටිය එවිට නිදාගන්න ගියා. මම ආදරෙයි අද දවස ගැන.' },
  { id: 'Neg_Fun_0001', name: 'Joined words without proper spacing', input: 'mamabathkannavaa', expected: 'මම බත් කන්නවා' },
  { id: 'Neg_Fun_0002', name: 'Excessive spaces between words', input: 'mama        gedhara        yanavaa', expected: 'මම ගෙදර යනවා' },
  ...
  { id: 'Neg_Fun_0005', name: 'Excessive word repetition for emphasis', input: 'hari hari hari hari hari', expected: 'හරි හරි හරි හරි හරි' },
...
for (const data of testCases) {
  ...
  test('Pos_UI_0001: Real-time automatic output updates', async ({ page }) => {
    const inputLocator = page.locator('textarea').first();
    const outputLocator = page.locator('div.whitespace-pre-wrap').first();
